...
# Expand abbreviations so they pool with their full forms
abbrev_map = {
    r'\bXGB\b': 'XGBoost',
    ...
    r'\bNaN\b': 'missing',
    # fold redundant forms into canonical terms
    r'\bbinned\b': 'binning',
    r'\bbins\b': 'binning',
...
stopwords = [
    # code variable names that leaked in

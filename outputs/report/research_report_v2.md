...
**Attribution structure.** Two further figures underpin the community analysis of Section 4.6: Figure 12 shows the adoption frequency of canonized techniques across the corpus, and Figure 13 relates each entry's `origination_score` to the number of citations its author receives — quantifying the originator-versus-canonizer gap discussed there.

...
First, the corpus is well described by a small typology. The four main winning paradigms — ensemble-stacking, single-model heavy-FE, lookup-exploit, and problem-fit neural networks — account for 41 of 45 entries (91%). Ensemble-stacking is the strong majority at 28/45 (62%), with single-model heavy-FE (6/45, 13%), lookup-exploit (4/45, 9%), and problem-fit neural networks (3/45, 7%) representing the specialist minority. A fifth paradigm, community-template-tweak (3/45, 7%), captures entries where the winning solution is built primarily on a forked public notebook with one meaningful tweak; including it brings the typology's coverage to 44/45 (98%). One entry is classified as mixed.

Second, paradigm composition varies meaningfully by era. The three TPS competitions (2022) contributed two problem-fit-NN wins and one lookup-exploit win, with zero ensemble-stacking wins. From PS Season 3 onward, ensemble-stacking is the modal paradigm in every era, accounting for 60–80% of wins per era. The diversity of paradigms peaks in PS Season 3, where five of the six paradigm categories appear at least once.
...
Fourth, community-graph centrality splits cleanly into three archetypes. The most-cited handle in the entire corpus (siukeitin, 12 citations) is never a top-three winner in our analysis set, representing a *pure technique-source* role. A second group (tilii7, masayakawamata) has one win each plus 5–8 citations — *respected members who occasionally win*. A third group (cdeotte at 6 wins + 6 citations, AmbrosM with team partner at 4 + 3, mahoganybuttstrings at 3 + 4) combines multiple top-three appearances with multiple citations — *dominant competitors who are also cited*. The most prominent author in our set (cdeotte) appears as a commenter on a writeup in February 2023, 22 months before his first win in the corpus (December 2024).
...
- **Dominant-competitor-also-cited.** Three handles combine multiple top-three appearances with multiple citations: cdeotte (6 top-three appearances + 6 citations), AmbrosM with team partner (4 + 3), and mahoganybuttstrings (3 + 4). Note that the "wins" axis in the centrality chart counts all top-three finishes, not only rank-1 wins.

[Figure 8 — cdeotte timeline. Source: `analysis/figures/phase5/phase5_42_cdeotte_timeline.png`]

The cdeotte timeline (Figure 8) is illustrative of the temporal dynamic between observation and dominance. cdeotte's earliest documented presence in the corpus is February 2023, when he commented on Bill Cruise's S3E3 winning writeup. His first win in the corpus is December 2024 (S4E12), 22 months later. Between those two dates, he appears in the corpus as a commenter, a non-winning competitor (placing 81st in S4E11, 806th at ICR), and as a cited source. After December 2024 his wins accelerate, producing five additional top-three appearances in the corpus over the following 15 months.

...
| 9 (Phase 2) | playground-series-s4e11 | 25 | **cdeotte** | writeup + NB | `25th Place - GBDT plus NN - Trust CV _ Kaggle.txt`, `25th place_s04e11-mental-health-prediction-ensemble.ipynb` | Mahdi r1 | minimal-fe | **Coded.** **THIRD AUTHOR OVERLAP — cdeotte is 6x winner in corpus.** His own 25th-place finish BEFORE his first PS win at s4e12 next month. Explicit choice: 'simple FE and simple solutions work well'. 3-model ensemble (2 forked + NN). n_fe_tech=1 (c10 all-cats), meta=2 (c51+c53). **Both winner Mahdi AND control cdeotte declared minimal FE** — paradigm structurally null comparison as anticipated. |
| 10 (Phase 2) | playground-series-s4e10 | 10 | **adaubas** | writeup + NB | `10th place solution _ no blind blend _ Kaggle.txt`, `10thplace_pss4e10-logistic-of-gbms.ipynb` | omid r2 | ensemble-standard | **Coded.** **FOURTH AUTHOR OVERLAP — adaubas is rank 1 winner at s4e5 Flood Prediction in our corpus.** LR of 4 meta-learners (each a stack of 30+ GBMs total) + RepeatedStratifiedKFold. Explicit 'I didn't made feature engineering'. **Permutation importance signature consistent with his s4e5 winning entry** (c48). n_fe_tech=1 (c48 perm imp), meta=1 (c51). |
